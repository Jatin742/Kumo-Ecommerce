                            ...
                            <div>
                                <div className="confirmShippingArea">
                                    ...
                                    <div className="orderDetailsContainerBox">
                                        ...
                                        <div>
                                            <p>Address:</p>
                                            <span>{order && order.shippingInfo && `${order.shippingInfo.address}, ${order.shippingInfo.city}, ${order.shippingInfo.state}, ${order.shippingInfo.pinCode}, ${order.shippingInfo.country}`}
                                            </span>
                                        </div>
                                    </div>
