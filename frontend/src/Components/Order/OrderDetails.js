                ...
                <div className="orderDetailsPage">
                    <div className="orderDetailsContainer">
                        ...
                        <div className="orderDetailsContainerBox">
                            ...
                            <div>
                                <p>Address:</p>
                                <span>{order.shippingInfo && `${order.shippingInfo.address}, ${order.shippingInfo.city}, ${order.shippingInfo.state}, ${order.shippingInfo.pinCode}, ${order.shippingInfo.country}`}
                                </span>
                            </div>
                        </div>
